				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="#">BOOVERY.COM</a></div>
							<nav class="main_nav">
								<ul>
							...
							<div class="header_extra ml-auto">
								<div class="shopping_cart">
									<a href="cart.php">
										...
										<div>Cart <span class="badge">0</span></div>
									</a>
								</div>
								<div class="search">
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<?php
                $sql = "SELECT items.id, items.name, items.description, items.price, items.author, items.isbn, category.category_name, items.img_url FROM items, category WHERE items.category_id = category.id";
