			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
                        ...
                        if($category_id != null){
                        $sql = "SELECT items.id, items.name, items.description, items.price, items.author, items.isbn, category.category_name, items.img_url FROM items, category WHERE items.category_id = category.id AND items.active = 1 AND items.category_id = ?";
